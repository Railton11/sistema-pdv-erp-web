...
echo '<div class="row"><div class="col-md-9"><h1>R$ <span id="sub_total">'.@$total_vendaF.'</span></h1></div><div class="col-md-3" align="right"><a href="index.php" style="text-decoration:none;" title="Fechar caixa" class="btn btn-outline-danger">Sair</a></div><div>';
