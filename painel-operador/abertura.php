...
$res = $pdo->prepare("INSERT caixa SET data_ab = curDate(), hora_ab = curTime(), valor_ab = :valor_ab, gerente_ab = :gerente_ab, caixa= :caixa, operador = '$id_usuario', status = 'Aberto'");
