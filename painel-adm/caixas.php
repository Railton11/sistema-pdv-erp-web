...
?>
<a class="btn btn-primary mt-2" href='index.php?pagina=<?php echo $pag ?>&funcao=novo' role="button">Novo Caixa</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST" id="form-excluir">
                <div class="modal-body">
                    <p>Deseja realmente excluir esse caixa?</p>
